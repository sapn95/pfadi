...
PreferenceSuites.runSharedStore()
SortingSuites.run()
FavouriteSuites.run()
WriteSuites.run()
...
ShareSuites.runPathBarReading()
ShareSuites.runKnownServers()
CredentialSuites.run()
CredentialSuites.runAgainstRealManager()
TransferSuites.run()
TransferSuites.runMessages()
CommandLineSuites.run()
CommandLineSuites.runUpgradeNotice()
FuzzySuites.run()
